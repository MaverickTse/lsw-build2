...
msbuild.exe LSMASHSourceVCX.vcxproj /target:Rebuild /property:Configuration=Release;Platform=x86;PlatformToolset=v120_xp;Optimize=true
REM chcp 65001
EOF
